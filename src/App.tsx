    ...
    <div className="App">
      <header className="App-header">
        <div style={{ width: "50%", textAlign: "left" }}>
          ...
          <p>
            Daniel Fernandes built the euJackpot app as an Ad Supported app.
            This SERVICE is provided by Daniel Fernandes at no cost and is
          ...
          <p>
            ...
            our Terms and Conditions, which is accessible at euJackpot unless
          ...
          <h2>Log Data</h2>
          <p>
            Log Data I want to inform you that whenever you use my Service, in a
          ...
          <p>
            Changes to This Privacy Policy I may update our Privacy Policy from
            time to time. Thus, you are advised to review this page periodically
            for any changes. I will notify you of any changes by posting the new
